...
- **High-risk/deep**: element-family extension API (de-duplicate the 14-file dispatch); needrefactor retirement plan; visibility/ABI macros; unique_ptr migration for unique ownership; distributed-memory strategy decision (revive BDDC vs external solver coupling); each needs expert review + regression nets.
