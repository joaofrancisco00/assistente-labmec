...
A posteriori: gradient reconstruction (Post/), dedicated ErrorEstimation work appears to live downstream (branch `develop-for-ErrorEstimation` [repo branch list]).
